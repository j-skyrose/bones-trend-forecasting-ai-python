...
def loadEDGARFinancialDumps():
    ...
    dbm.dbc.execute(f'''INSERT OR IGNORE INTO vwtb_edgar_quarters 
        ...
        FROM {dbm.getTableString("financial_stmts_sub_data_set_edgar_d")} s JOIN {dbm.getTableString("financial_stmts_num_data_set_edgar_d")} n ON s.adsh = n.adsh 
    ...
    dbm.dbc.execute(f'''INSERT OR IGNORE INTO vwtb_edgar_financial_nums
        SELECT DISTINCT s.exchange, s.symbol, n.tag, n.ddate, n.qtrs, n.uom, n.value, n.duplicate 
            FROM {dbm.getTableString("financial_stmts_num_data_set_edgar_d")} n JOIN {dbm.getTableString("financial_stmts_sub_data_set_edgar_d")} s, {dbm.getTableString("financial_stmts_tag_data_set_edgar_d")} t ON n.adsh = s.adsh AND n.tag = t.tag AND n.version = t.version
